...
def parse_args():
    ...
    parser.add_argument('--sys_root', metavar='sys_root', type=str, default='/home/ec2-user/SageMaker/csiro-aos-object-detection')
...
def get_dataset(dataset, args):
    if dataset.lower() == 'voc':
        ...
        train_dataset = VOCLike(root=args.sys_root, splits=((args.voc_base, f'{args.train_yr}'+'/train'),))
        val_dataset = VOCLike(root=args.sys_root, splits=((args.voc_base, f'{args.train_yr}'+'/val'),))
        val_metric = VOC07MApMetric(iou_thresh=0.5, class_names=val_dataset.classes)
    else:
